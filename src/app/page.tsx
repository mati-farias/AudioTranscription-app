...
import TranscriptionComponent from '@/app/components/Transcription';
import ReactPlayer from 'react-player';
import AudioPlayerContainer from '@/app/components/AudioPlayerContainer';
import { Message } from '@/Types';
import UploadActions from '@/app/UploadActions';
  ...
  return (
    <div className='container mx-auto px-4 py-4 '>
      <h1 className='text-xl font-bold my-4 text-center'>
        ...
        <HomeContainer messages={messages}/>
